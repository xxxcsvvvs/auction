...
<style>
    *{
    ...
    .body{
        margin: 3px 0 3px 0; width: 1900px; border: 1px solid;
    }
    .body::after{
    ...
    .chat-bottom{
        height: 117px;box-sizing: border-box; 
	...
	.chat_par{
	border-radius: 10px; margin-top:1px ;margin-bottom: 1px; border:1px solid #666; padding: 5px;
	}
</style>
<body>
    <div class="body">
        <div class="box left">
            ...
            <div class="product-seller">
                ...
                <a href="#" class="sel_btn" >판매자 찜
                    <span class="all_icon"></span>
                </a>
                <a href='<c:url value="/userStore/${auctionSeller.getMe_id()}"></c:url>' class="more_btn" >판매자 상품 보기
        ...
        <div class="box mid">
            ...
            <div>           	
        		<button type="button" onclick="closeSocket();" class="chat_par">대화방 나가기</button>
        		<button type="button" onclick="openSocket();"class="chat_par">대화방 참여</button>
            	</div>
            <div class="chat-bottom">
            	
            	<input type="hidden" id="room" value="${roomNumber}"> 
        		<input type="hidden" id="sender" value="${userId}">
                <input type="text" id="messageinput" placeholder="내용을 입력해주세요.">
                <button type="button" onclick="send();" id="message_send">전송</button>
            </div>
        </div>
        <div class="box right">
                    ...
                    <li class="currnent">
                        <dl>
                            ...
                            <dd>
                                ...
                                <button class="history_btn" id="modal_open_btn3"  >
                                    <span class="all_icon"></span>
                                    입찰내역보기
                                </button>
                    ...
                    <li class="est pd5">
                        <dl>
                            ...
                            <dd>
                                ...
                                <button class="est_view" id="modal_open_btn2">
                                    자세히보기
                                    <span class="all_icon"></span>
                                </button>
                                
                                
                                <button style="display: none" class="est_ok" id="delivery_btn" >
                            		배송지설정
                            	<span class="all_icon"></span>
                            	
                        		</button>
                                <button class="est_ok" id="modal_open_btn1" >
                                    입찰신청
                                    <span class="all_icon"></span>
                                </button>
