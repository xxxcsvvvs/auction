...
<div class="container">
	<div class="container-box">
		...
		<form action="<c:url value='/product/update/${product.pr_code}'></c:url>" method="post" enctype="multipart/form-data">
		    <div class="form-group">
			    <label for="name">상품명</label>
			    <div class="form-control">
			   		<input type="text" id="name" name="pr_name" value="${product.pr_name }" style="border:none" >
			    </div>
		    </div>
			<div class="form-group">
			    <label for="intro">상품소개</label>
			    <div class="form-control">
				    <input type="text" id="intro" name="pr_intro" value="${product.pr_intro }" style="border:none">    
			    </div>
			</div>
			<div class="form-group">
			    <label for="condition">상품상태</label>
			    <div class="form-control">
				    <input type="text" id="condition" name="pr_condition" value="${product.pr_condition }" style="border:none">			    
			    </div>
			</div>
			<div class="form-group">
			    <label for="detail">상세정보</label>
			    <div class="form-control">
				    <input type="text" id="detail" name="pr_detail" value="${product.pr_detail }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
			    <label for="location">상품위치</label>
			    <div class="form-control">
				    <input type="text" id="location" name="pr_location" value="${product.pr_location }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
				<label>반품수용여부</label>
				<div class="form-control">
				    <input type="text" id="refund_ok" name="pr_refund_ok" value="${product.pr_refund_ok }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
				<label>반품수용기간</label>
				<div class="form-control">
				    <input type="text" id="refunddate" name="pr_refund_date" value="${product.pr_refund_date }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
				<label>환불가능조건</label>
				<div class="form-control">
				    <input type="text" id="refundreason" name="pr_refund_reason" value="${product.pr_refund_reason }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
			    <label for="startprice">경매시작가격</label>
			    <div class="form-control">
				    <input type="text" id="startprice" name="pr_start_price" value="${product.pr_start_price }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
			    <label for="origin">원산지</label>
			    <div class="form-control">
				    <input type="text" id="origin" name="pr_origin"  value="${product.pr_origin }" style="border:none">
			    </div>
			</div>
			<div class="form-group">
			    <label for="price">물품크기</label>
			    <div class="form-control">
				    <input type="text" id="size" name="pr_size"  value="${product.pr_size }" style="border:none">
			    </div>
			</div>
